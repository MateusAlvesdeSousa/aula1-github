...
public class Salario {
	...
	public static void main(String[] args) {
		...
		System.out.print("Informe o Nome: ");
		 ...
		 System.out.print("Informe a Taxa sobre o Salário: R$ ");
		 ...
		 System.out.println();
		 System.out.print("Qual a porcentagem de aumento do sálario? ");
		  double percentage = teclado.nextDouble();
		  empregado.increaseSalary(percentage);
		 System.out.printf("Salário Atualizado: " + empregado.name + ", R$ " + String.format("%.2f", empregado.netSalary()));
